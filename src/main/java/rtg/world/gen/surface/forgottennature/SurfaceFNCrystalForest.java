...
public class SurfaceFNCrystalForest extends SurfaceBase {
    ...
    public SurfaceFNCrystalForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
