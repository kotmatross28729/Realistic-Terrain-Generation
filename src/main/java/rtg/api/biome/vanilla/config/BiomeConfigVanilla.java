...
public class BiomeConfigVanilla {
    ...
    public static BiomeConfig[] getBiomeConfigs() {
        BiomeConfig[] biomeConfigs = new BiomeConfig[] { biomeConfigVanillaBeach, biomeConfigVanillaBirchForest,
            biomeConfigVanillaBirchForestHills, biomeConfigVanillaBirchForestHillsM, biomeConfigVanillaBirchForestM,
            biomeConfigVanillaColdBeach, biomeConfigVanillaColdTaiga, biomeConfigVanillaColdTaigaHills,
            biomeConfigVanillaColdTaigaM, biomeConfigVanillaDeepOcean, biomeConfigVanillaDesert,
            biomeConfigVanillaDesertHills, biomeConfigVanillaDesertM, biomeConfigVanillaExtremeHills,
            biomeConfigVanillaExtremeHillsEdge, biomeConfigVanillaExtremeHillsM, biomeConfigVanillaExtremeHillsPlus,
            biomeConfigVanillaExtremeHillsPlusM, biomeConfigVanillaFlowerForest, biomeConfigVanillaForest,
            biomeConfigVanillaForestHills, biomeConfigVanillaFrozenOcean, biomeConfigVanillaFrozenRiver,
            biomeConfigVanillaIceMountains, biomeConfigVanillaIcePlains, biomeConfigVanillaIcePlainsSpikes,
            biomeConfigVanillaJungle, biomeConfigVanillaJungleEdge, biomeConfigVanillaJungleEdgeM,
            biomeConfigVanillaJungleHills, biomeConfigVanillaJungleM, biomeConfigVanillaMegaSpruceTaiga,
            biomeConfigVanillaMegaTaiga, biomeConfigVanillaMegaTaigaHills, biomeConfigVanillaMesa,
            biomeConfigVanillaMesaBryce, biomeConfigVanillaMesaPlateau, biomeConfigVanillaMesaPlateauF,
            biomeConfigVanillaMesaPlateauFM, biomeConfigVanillaMesaPlateauM, biomeConfigVanillaMushroomIsland,
            biomeConfigVanillaMushroomIslandShore, biomeConfigVanillaOcean, biomeConfigVanillaPlains,
            biomeConfigVanillaRedwoodTaigaHills, biomeConfigVanillaRiver, biomeConfigVanillaRoofedForest,
            biomeConfigVanillaRoofedForestM, biomeConfigVanillaSavanna, biomeConfigVanillaSavannaM,
            biomeConfigVanillaSavannaPlateau, biomeConfigVanillaSavannaPlateauM, biomeConfigVanillaStoneBeach,
            biomeConfigVanillaSunflowerPlains, biomeConfigVanillaSwampland, biomeConfigVanillaSwamplandM,
            biomeConfigVanillaTaiga, biomeConfigVanillaTaigaHills, biomeConfigVanillaTaigaM };
