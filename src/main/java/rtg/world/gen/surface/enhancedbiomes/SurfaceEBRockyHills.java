...
public class SurfaceEBRockyHills extends SurfaceEBBase {
    ...
    public SurfaceEBRockyHills(BiomeConfig config, Block top, byte topByte, Block fill, byte fillByte, boolean genBeach,
        Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff,
        Block mixBlock, byte modMixByte, Block modMixBlock2, byte modMix2Byte, float mixSize) {
