...
public class SurfaceHLBirchHills extends SurfaceBase {
    ...
    public SurfaceHLBirchHills(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
