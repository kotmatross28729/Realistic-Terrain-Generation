...
public class SurfaceATGVolcano extends SurfaceBase {
    ...
    public SurfaceATGVolcano(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
