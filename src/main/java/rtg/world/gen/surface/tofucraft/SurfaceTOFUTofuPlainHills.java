...
public class SurfaceTOFUTofuPlainHills extends SurfaceBase {
    ...
    public SurfaceTOFUTofuPlainHills(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
