...
public class SurfaceEBOakForest extends SurfaceEBBase {
    ...
    public SurfaceEBOakForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
