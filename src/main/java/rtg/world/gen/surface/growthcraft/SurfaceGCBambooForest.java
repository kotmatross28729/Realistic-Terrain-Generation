package rtg.world.gen.surface.growthcraft;
...
public class SurfaceGCBambooForest extends SurfaceBase {
    ...
    public SurfaceGCBambooForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
