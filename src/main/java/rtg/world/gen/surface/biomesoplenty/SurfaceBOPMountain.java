...
public class SurfaceBOPMountain extends SurfaceBase {
    ...
    public SurfaceBOPMountain(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
