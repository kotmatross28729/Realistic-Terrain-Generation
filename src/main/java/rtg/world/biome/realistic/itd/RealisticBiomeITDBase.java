...
public class RealisticBiomeITDBase extends RealisticBiomeBase {
    ...
    public RealisticBiomeITDBase(BiomeConfig config, BiomeGenBase b, BiomeGenBase riverbiome, TerrainBase t,
        SurfaceBase s) {
        ...
        if (Loader.isModLoaded("InTheDarkness")) {
            ...
            for (int i = 0; i < 256; i++) {
                if (b[i] != null) {
                    ...
                    String biomeClass = itdBiome.getBiomeClass()
                        .getName();

                    if (biomeName.equals("darkForest")
                        && biomeClass.equals("mod.mcreator.mcreator_darkForest$BiomeGendarkForest")) {
                        itdDarkForest = new RealisticBiomeITDDarkForest(
                            itdBiome,
                            BiomeConfigITD.biomeConfigITDDarkForest);
                    }
                }
            }
        }
