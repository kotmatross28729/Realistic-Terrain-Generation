...
public class SurfaceEBScree extends SurfaceEBBase {
    ...
    public SurfaceEBScree(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
        byte mixTopByte, Block mixFiller, byte mixFillerByte, Block cliff1, byte cliff1Byte, Block cliff2,
