...
public class RealisticBiomeEBRockyDesert extends RealisticBiomeEBBase {
    ...
    public static byte[] ebDominantStoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.HARDENED_SANDSTONE, (byte) 0),
    ...
    public static byte[] ebDominantCobblestoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.HARDENED_SANDSTONE, (byte) 0),
        EBAPI.ebStonify(EBAPI.MARBLE, (byte) 0) };
    ...
    public RealisticBiomeEBRockyDesert(BiomeGenBase ebBiome, BiomeConfig config) {
        ...
        decoEBRockSpire.materials = new Block[] { EBAPI.ebStonify(EnhancedBiomesBlocks.stoneEB, Blocks.stone),
            (EnhancedBiomesMod.useNewStone == 1) ? EnhancedBiomesBlocks.stoneCobbleEB : Blocks.cobblestone,
            Blocks.sandstone };
        decoEBRockSpire.meta = new byte[] { EBAPI.ebStonify(EBAPI.HARDENED_SANDSTONE, (byte) 0),
            EBAPI.ebStonify(EBAPI.HARDENED_SANDSTONE, (byte) 0), 0 };
