...
public class WorldChunkManagerRTG extends WorldChunkManager implements RTGBiomeProvider {
        ...
        for (int i1 = 0; i1 < par4 * par5; ++i1) {
            ...
            try {
                ...
                if (RealisticBiomeBase.getBiome(biome) == null) {
                    f = (float) biomePatcher
                        .getPatchedRealisticBiome("Problem with biome " + biome + " from " + e.getMessage()).baseBiome
                            .getIntRainfall()
                        / 65536.0F;
                }
            }
    ...
    public float getRiverStrength(int x, int y) {
        ...
        return river.octave(0)
            .border2(xRiver, yRiver, riverValleyLevel, 1f);
    }
        ...
        if (par6 && par4 == 16 && par5 == 16 && (par2 & 15) == 0 && (par3 & 15) == 0) {
            ...
            for (int i1 = 0; i1 < par4 * par5; ++i1) {
                try {
                    ...
                    par1ArrayOfBiomeGenBase[i1] = biomePatcher
                        .getPatchedBaseBiome(genBiomes.toString() + " " + this.biomeIndexLayer.toString());
                }
