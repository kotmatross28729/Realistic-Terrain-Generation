...
public class ConfigRTG {
    ...
    public static byte[] mesaBrycePlateauBlockMetas = getPlateauGradientBlockMetasFromConfigString(
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            flatBedrockLayers = config.getInt(
            ...
            bedrockBlockId = config.getString(
                ...
                "Bedrock",
                bedrockBlockId,
                "The block to use for the bottom of the Overworld." + Configuration.NEW_LINE);

            bedrockBlockByte = config.getInt(
                "Bedrock block meta value",
                "Bedrock",
                bedrockBlockByte,
                0,
                15,
                "The meta value of the bedrock block." + Configuration.NEW_LINE);
            ...
            cobblestoneBoulderChance = config.getInt(
                ...
                1,
                100,
                "1 = Always generate if possible; 2 = 50% chance; 4 = 25% chance" + Configuration.NEW_LINE);

            enableUBCBoulders = config.getBoolean(
                "UBC Boulders",
                "Boulders",
                enableUBCBoulders,
                "Set this to TRUE to allow UBC to override cobblestone boulders." + Configuration.NEW_LINE
            ...
            enableCaveModifications = config.getBoolean(
                ...
                "Must be set to TRUE for the other cave settings to have any effect." + Configuration.NEW_LINE
                    + "If FALSE, RTG won't interfere with cave generation at all."
                    + Configuration.NEW_LINE);

            enableCaves = config.getBoolean("Enable Caves", "Caves", enableCaves, "");
            caveDensity = config.getInt(
                "Cave Density",
                "Caves",
                caveDensity,
                1,
                40,
                "This setting controls the size of caves." + Configuration.NEW_LINE
                    + "HIGHER values = BIGGER caves & MORE lag. (14 = vanilla cave density)"
                    + Configuration.NEW_LINE);
            caveFrequency = config.getInt(
                "Cave Frequency",
                "Caves",
                caveFrequency,
                1,
                40,
                "This setting controls the number of caves that generate." + Configuration.NEW_LINE
                    + "LOWER values = MORE caves & MORE lag. (6 = vanilla cave frequency)"
                    + Configuration.NEW_LINE);

            /* ==================== Dunes ==================== */

            duneHeight = config.getInt(
                "Height of Dunes",
                "Dunes",
                duneHeight,
                1,
                12,
                "This setting controls the height of both sand dunes and snow dunes." + Configuration.NEW_LINE
            ...
            enableDebugging = config.getBoolean(
                ...
                "Debugging",
                enableDebugging,
                "WARNING: This should only be enabled if you know what you're doing." + Configuration.NEW_LINE);
            ...
            dungeonFrequency = config.getInt(
                "Dungeon Frequency",
                "Dungeons",
                dungeonFrequency,
                1,
                200,
                "This setting controls the number of dungeons that generate." + Configuration.NEW_LINE
            ...
            enableWorldTypeNotificationScreen = config
                .getBoolean("Enable World Type Notification Screen", "GUI", enableWorldTypeNotificationScreen, "");

            /* ==================== Lakes (Surface) ==================== */

            enableWaterSurfaceLakes = config
                .getBoolean("Enable Water Surface Lakes", "Lakes (Surface)", enableWaterSurfaceLakes, "");
            waterSurfaceLakeChance = config.getInt(
                "1/x chance that Water Surface Lakes will generate if given the opportunity to do so during world gen",
                "Lakes (Surface)",
                waterSurfaceLakeChance,
                1,
                100,
                "1 = Always generate if possible; 2 = 50% chance; 4 = 25% chance" + Configuration.NEW_LINE);

            enableLavaSurfaceLakes = config
                .getBoolean("Enable Lava Surface Lakes", "Lakes (Surface)", enableLavaSurfaceLakes, "");
            lavaSurfaceLakeChance = config.getInt(
                "1/x chance that Lava Surface Lakes will generate if given the opportunity to do so during world gen",
                "Lakes (Surface)",
                lavaSurfaceLakeChance,
                1,
                100,
                "1 = Always generate if possible; 2 = 50% chance; 4 = 25% chance" + Configuration.NEW_LINE);
            ...
            enableWaterUndergroundLakes = config
                .getBoolean("Enable Water Underground Lakes", "Lakes (Underground)", enableWaterUndergroundLakes, "");
            waterUndergroundLakeChance = config.getInt(
                "1/x chance that Water Underground Lakes will generate if given the opportunity to do so during world gen",
                "Lakes (Underground)",
                waterUndergroundLakeChance,
                1,
                100,
                "1 = Always generate if possible; 2 = 50% chance; 4 = 25% chance" + Configuration.NEW_LINE);

            enableLavaUndergroundLakes = config
                .getBoolean("Enable Lava Underground Lakes", "Lakes (Underground)", enableLavaUndergroundLakes, "");
            lavaUndergroundLakeChance = config.getInt(
                "1/x chance that Lava Underground Lakes will generate if given the opportunity to do so during world gen",
                "Lakes (Underground)",
                lavaUndergroundLakeChance,
                1,
                100,
                "1 = Always generate if possible; 2 = 50% chance; 4 = 25% chance" + Configuration.NEW_LINE);
            ...
            plateauBlockByte = config.getInt(
                "Plateau Block Meta Value",
                "Plateaus",
                plateauBlockByte,
                0,
                15,
                "The meta value of the plateau block." + Configuration.NEW_LINE);

            mesaPlateauBlockMetas = getPlateauGradientBlockMetasFromConfigString(
                config.getString(
            ...
            mesaBrycePlateauBlockMetas = getPlateauGradientBlockMetasFromConfigString(
                config.getString(
            ...
            savannaPlateauBlockMetas = getPlateauGradientBlockMetasFromConfigString(
                config.getString(
            ...
            enableRavineModifications = config.getBoolean(
                ...
                "Must be set to TRUE for the other ravine settings to have any effect." + Configuration.NEW_LINE
            ...
            ravineFrequency = config.getInt(
                "Ravine Frequency",
                "Ravines",
                ravineFrequency,
                1,
                100,
                "This setting controls the number of ravines that generate." + Configuration.NEW_LINE
            ...
            enableRTGSaplings = config.getBoolean(
                ...
                "Saplings",
                enableRTGSaplings,
                "Set this to TRUE to allow RTG's custom trees to grow from vanilla saplings." + Configuration.NEW_LINE
            ...
            rtgTreeChance = config.getInt(
                ...
                1,
                Integer.MAX_VALUE,
                "1/x chance that a vanilla sapling will grow one of RTG's custom trees." + Configuration.NEW_LINE
            ...
            generateScatteredFeatures = config
                .getBoolean("Generate Scattered Features", "Scattered Features", generateScatteredFeatures, "");

            minDistanceScatteredFeatures = config.getInt(
                ...
                "Scattered features = desert temples, jungle temples, and witch huts; 8 = Vanilla"
                    + Configuration.NEW_LINE);
            maxDistanceScatteredFeatures = config.getInt(
            ...
            enableSnowLayers = config.getBoolean(
                "Enable Snow Layers",
                "Snow",
                enableSnowLayers,
            ...
            shadowStoneBlockByte = config.getInt(
                "Stone shadow block meta value",
                "Terrain shadowing",
                shadowStoneBlockByte,
                0,
                15,
                "The meta value of the shadow block for stone cliffs. Defaults to " + shadowStoneBlockByte
                    + " (cyan)."
                    + Configuration.NEW_LINE);
            ...
            shadowDesertBlockByte = config.getInt(
                "Desert shadow block meta value",
                "Terrain shadowing",
                shadowDesertBlockByte,
                0,
                15,
                "The meta value of the shadow block for desert cliffs. Defaults to " + shadowDesertBlockByte
                    + " (white)."
                    + Configuration.NEW_LINE);
            ...
            enableUBCStoneShadowing = config.getBoolean(
                ...
                "Set this to TRUE to allow UBC to override stone shadowing." + Configuration.NEW_LINE
                    + "This setting doesn't have any effect if UBC is not installed."
                    + Configuration.NEW_LINE);
            ...
            enableUBCDesertShadowing = config.getBoolean(
                ...
                "Set this to TRUE to allow UBC to override desert shadowing." + Configuration.NEW_LINE
                    + "This setting doesn't have any effect if UBC is not installed."
                    + Configuration.NEW_LINE);
            ...
            allowTreesToGenerateOnSand = config.getBoolean(
                ...
                "Set this to FALSE to prevent trees from generating on sand." + Configuration.NEW_LINE
            ...
            enableVillageModifications = config.getBoolean(
                ...
                "Set this to FALSE to resolve issues with mods that also modify villages." + Configuration.NEW_LINE
            ...
            villageSize = config.getInt(
                "Size of villages",
                "Villages",
                villageSize,
                0,
                10,
                "Higher values = bigger villages; 0 = Vanilla" + Configuration.NEW_LINE);
            minDistanceVillages = config.getInt(
                "Minimum distance between villages",
                "Villages",
                minDistanceVillages,
                1,
                Integer.MAX_VALUE,
                "Higher values = villages further apart; 8 = Vanilla" + Configuration.NEW_LINE);
            maxDistanceVillages = config.getInt(
                "Maximum distance between villages",
                "Villages",
                maxDistanceVillages,
                1,
                Integer.MAX_VALUE,
                "Lower values = villages closer together; 32 = Vanilla" + Configuration.NEW_LINE);
            ...
            volcanoBlockId = config.getString(
                ...
                "Volcanoes",
                volcanoBlockId,
                "The main block to use for the surface of the volcano." + Configuration.NEW_LINE);

            volcanoBlockMeta = config.getInt(
                "Volcano block meta value",
                "Volcanoes",
                volcanoBlockMeta,
                0,
                15,
                "The meta value of the volcano block." + Configuration.NEW_LINE);

            volcanoMix1BlockId = config.getString(
                "Volcano mix 1 block ID",
                "Volcanoes",
                volcanoMix1BlockId,
                "The block ID of the 1st volcano mix block." + Configuration.NEW_LINE);

            volcanoMix1BlockMeta = config.getInt(
                "Volcano mix 1 block meta value",
                "Volcanoes",
                volcanoMix1BlockMeta,
                0,
                15,
                "The meta value of the 1st volcano mix block." + Configuration.NEW_LINE);

            volcanoMix2BlockId = config.getString(
                "Volcano mix 2 block ID",
                "Volcanoes",
                volcanoMix2BlockId,
                "The block ID of the 2nd volcano mix block." + Configuration.NEW_LINE);

            volcanoMix2BlockMeta = config.getInt(
                "Volcano mix 2 block meta value",
                "Volcanoes",
                volcanoMix2BlockMeta,
                0,
                15,
                "The meta value of the 2nd volcano mix block." + Configuration.NEW_LINE);

            volcanoMix3BlockId = config.getString(
                "Volcano mix 3 block ID",
                "Volcanoes",
                volcanoMix3BlockId,
                "The block ID of the 3rd volcano mix block." + Configuration.NEW_LINE);

            volcanoMix3BlockMeta = config.getInt(
                "Volcano mix 3 block meta value",
                "Volcanoes",
                volcanoMix3BlockMeta,
                0,
                15,
                "The meta value of the 3rd volcano mix block." + Configuration.NEW_LINE);

            enableVolcanoes = config.getBoolean(
                "Enable volcanoes",
                "Volcanoes",
                enableVolcanoes,
                "Set this to FALSE to prevent volcanoes from generating." + Configuration.NEW_LINE);

            enableVolcanoEruptions = config.getBoolean(
                "Enable volcano eruptions",
                "Volcanoes",
                enableVolcanoEruptions,
                "Set this to FALSE to prevent lava from flowing down the sides of volcanoes." + Configuration.NEW_LINE);
            ...
            scenicLakeBiome = config.getInt(
                "Biome for scenic lakes",
                riversAndLakes,
                7,
                0,
                254,
                "Biome ID for scenic lakes when not frozen (default 7 = River)" + Configuration.NEW_LINE);

            scenicFrozenLakeBiome = config.getInt(
                "Biome for frozen scenic lakes",
                riversAndLakes,
                11,
                0,
                254,
                "Biome ID for scenic lakes when frozen (default 11 = Frozen River)" + Configuration.NEW_LINE);
    ...
    private static String getPlateauGradientBlockMetasComment(String biomeName) {
        String comment = "Comma-separated list of meta values for the plateau gradient blocks used in the " + biomeName
            + "."
            + Configuration.NEW_LINE
