...
public class SurfaceEBXLPineForest extends SurfaceBase {
    ...
    public SurfaceEBXLPineForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
