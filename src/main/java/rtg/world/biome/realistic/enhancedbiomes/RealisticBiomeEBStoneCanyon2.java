...
public class RealisticBiomeEBStoneCanyon2 extends RealisticBiomeEBBase {
    ...
    public static byte[] ebDominantStoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.BASALT, (byte) 0),
    ...
    public static byte[] ebDominantCobblestoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.BASALT, (byte) 0),
        EBAPI.ebStonify(EBAPI.GABBRO, (byte) 0) };
    ...
    public RealisticBiomeEBStoneCanyon2(BiomeGenBase ebBiome, BiomeConfig config) {
        ...
        this.addDeco(decoFallenTree, this.config._boolean(BiomeConfigEBStoneCanyon2.decorationLogsId));
