...
public class SurfaceEBRainforestValley extends SurfaceEBBase {
    ...
    public SurfaceEBRainforestValley(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
