...
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCAmethyst;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCAmethystGrove;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCArctic;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCAutilField;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCBone;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCDeadLand;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCDeathForest;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCFertile;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCFlamage;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCGlassland;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCHighLands;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCHive;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCObsidianForest;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCOcher;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCSnowyDesert;
import rtg.api.biome.eccentricbiomes.config.BiomeConfigECCVoid;
