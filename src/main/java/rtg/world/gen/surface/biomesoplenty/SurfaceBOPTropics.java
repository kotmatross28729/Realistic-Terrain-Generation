...
public class SurfaceBOPTropics extends SurfaceBase {
    ...
    public SurfaceBOPTropics(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
