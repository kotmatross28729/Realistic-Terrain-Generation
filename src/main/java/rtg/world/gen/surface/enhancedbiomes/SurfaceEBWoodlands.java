...
public class SurfaceEBWoodlands extends SurfaceEBBase {
    ...
    public SurfaceEBWoodlands(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
