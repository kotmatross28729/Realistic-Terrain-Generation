...
public class MapGenRavineRTG extends MapGenRavine {
    ...
    protected void func_151540_a(long p_151540_1_, int p_151540_3_, int p_151540_4_, Block[] p_151540_5_,
        ...
        for (; p_151540_15_ < p_151540_16_; ++p_151540_15_) {
            double d12 = 1.5D
                + (double) (MathHelper.sin((float) p_151540_15_ * (float) Math.PI / (float) p_151540_16_) * p_151540_12_
                    * 1.0F);
    ...
    protected void func_151538_a(World world, int chunkX, int chunkZ, int p_151538_4_, int p_151538_5_,
        ...
        if (biome != null) {
            ...
            if (realisticBiome != null) {
                ravineFrequency = (realisticBiome.config._int(BiomeConfig.ravineFrequencyId) > -1)
