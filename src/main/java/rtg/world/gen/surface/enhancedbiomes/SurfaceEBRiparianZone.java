...
public class SurfaceEBRiparianZone extends SurfaceEBBase {
    ...
    public SurfaceEBRiparianZone(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
