...
public class SurfaceEBWoodlandHills extends SurfaceEBBase {
    ...
    public SurfaceEBWoodlandHills(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
