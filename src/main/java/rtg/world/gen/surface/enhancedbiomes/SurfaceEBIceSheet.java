...
public class SurfaceEBIceSheet extends SurfaceEBBase {
    ...
    public SurfaceEBIceSheet(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
