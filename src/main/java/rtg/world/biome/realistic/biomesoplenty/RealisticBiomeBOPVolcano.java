...
public class RealisticBiomeBOPVolcano extends RealisticBiomeBOPBase {
    ...
    private static Block bopTopBlock = GameData.getBlockRegistry()
        .getObject("BiomesOPlenty:ashStone");
    private static byte bopTopByte = (byte) 0;
    private static Block bopFillBlock = GameData.getBlockRegistry()
        .getObject("BiomesOPlenty:ashStone");
    private static byte bopFillByte = (byte) 0;
    private static Block bopMixTopBlock = GameData.getBlockRegistry()
        .getObject("BiomesOPlenty:ash");
    private static byte bopMixTopByte = (byte) 0;
    private static Block bopMixFillBlock = GameData.getBlockRegistry()
        .getObject("BiomesOPlenty:ashStone");
    private static byte bopMixFillByte = (byte) 0;
    private static Block bopCliff1Block = GameData.getBlockRegistry()
        .getObject("BiomesOPlenty:ashStone");
    private static byte bopCliff1Byte = (byte) 0;
    private static Block bopCliff2Block = GameData.getBlockRegistry()
        .getObject("BiomesOPlenty:ash");
