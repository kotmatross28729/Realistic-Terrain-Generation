...
public class SurfaceFNEucalyptusForest extends SurfaceBase {
    ...
    public SurfaceFNEucalyptusForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
