...
public class NecroData {
    ...
    public void addChapter(Chapter chapter) {
        for (Chapter chap : chapters) if (chap.identifier.equals(chapter.identifier)) {
            chap = chapter;
            return;
        }
    ...
    public void removeChapter(String identifier) {
        ...
        for (Chapter chap : oldchap) if (chap.identifier.equals(identifier)) {
            for (Chapter chapnew : newchap)
                for (Chapter chap2 : oldchap) if (chap2 != null && !chap2.identifier.equals(identifier)) {
                    chapnew = chap2;
                    chap2 = null;
                    break;
                }
    ...
    // return "NecroData{Title: "+title + ",Information: "+(information != null ? "Yes" : "No") +",PageData:
    // "+pageData.toString() +"}";
    // }
    ...
    public static class Chapter {
        ...
        public void addPage(Page page) {
            if (pages.size() < 40) pages.put(page.pageNum, page);
        }
        ...
        public void removePage(int pageNum) {
            if (pages.containsKey(pageNum)) pages.remove(pageNum);
        }
    ...
    public static class Page {
        ...
        public Page(int pageNum, Object icon, String text) {
            ...
            if (icon != null) if (!(icon instanceof ResourceLocation) && !(icon instanceof ItemStack)
                && !(icon instanceof CraftingStack))
