...
public class SurfaceEBStoneCanyon extends SurfaceEBBase {
    ...
    public SurfaceEBStoneCanyon(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
