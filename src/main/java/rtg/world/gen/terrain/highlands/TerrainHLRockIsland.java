...
public class TerrainHLRockIsland extends TerrainBase {
     ...
     */
    public TerrainHLRockIsland(float hillHeight, float hillWidth, float varHeight, float varWidth, float lakeHeight,
