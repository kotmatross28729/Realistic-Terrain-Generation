...
public class SurfaceHLPinelands extends SurfaceBase {
    ...
    public SurfaceHLPinelands(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
