...
public class SurfaceFNCherryBlossomWoodland extends SurfaceBase {
    ...
    public SurfaceFNCherryBlossomWoodland(BiomeConfig config, Block top, Block fill, boolean genBeach,
