...
public class BiomeConfig {
    ...
    public BiomeConfig(String modSlug, String biomeSlug) {
        ...
        this.addProperty(
            new BiomeConfigProperty(
                volcanoChanceId,
                Type.INTEGER,
                volcanoChanceName,
                "1/x chance that a volcano will generate if this biome has volcanoes enabled." + Configuration.NEW_LINE
        ...
        this.addProperty(
            new BiomeConfigProperty(
                ...
                "If you're using a custom top block, enter its numeric data value here." + Configuration.NEW_LINE
        ...
        this.addProperty(
            new BiomeConfigProperty(
                ...
                "If you're using a custom filler block, enter its numeric data value here." + Configuration.NEW_LINE
