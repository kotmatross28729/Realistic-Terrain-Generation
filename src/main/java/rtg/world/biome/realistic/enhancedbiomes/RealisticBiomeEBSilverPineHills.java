...
public class RealisticBiomeEBSilverPineHills extends RealisticBiomeEBBase {
    ...
    public static byte[] ebDominantStoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.DOLOMITE, (byte) 0),
    ...
    public static byte[] ebDominantCobblestoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.DOLOMITE, (byte) 0),
        EBAPI.ebStonify(EBAPI.SLATE, (byte) 0) };
    ...
    public RealisticBiomeEBSilverPineHills(BiomeGenBase ebBiome, BiomeConfig config) {
        super(
            config,
            ebBiome,
            BiomeGenBase.river,
            new TerrainEBSilverPineHills(72f, 30f),
            new SurfaceEBSilverPineHills(
                config,
