package rtg.world.gen.surface.eccentricbiomes;
...
public class SurfaceECCObsidianForest extends SurfaceBase {

    public SurfaceECCObsidianForest(BiomeConfig config, Block top, Block filler) {
