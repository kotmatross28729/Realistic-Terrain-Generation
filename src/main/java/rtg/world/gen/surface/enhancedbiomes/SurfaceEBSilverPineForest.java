...
public class SurfaceEBSilverPineForest extends SurfaceEBBase {
    ...
    public SurfaceEBSilverPineForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
