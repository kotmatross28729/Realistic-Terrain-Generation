...
public class SurfaceFNMapleForest extends SurfaceBase {
    ...
    public SurfaceFNMapleForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
