...
public class BiomeConfigRW {
    ...
    public static BiomeConfig[] getBiomeConfigs() {
        BiomeConfig[] biomeConfigs = new BiomeConfig[] { biomeConfigRWBotanicalGarden, biomeConfigRWMurica,
            biomeConfigRWMountainOfMadness, biomeConfigRWOssuary, biomeConfigRWRockCandyMountain,
            biomeConfigRWShadowFen, biomeConfigRWSpookyForest };
