...
public class RealisticBiomeEBGlacier extends RealisticBiomeEBBase {
    ...
    public static byte[] ebDominantStoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.LIMESTONE, (byte) 0),
    ...
    public static byte[] ebDominantCobblestoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.LIMESTONE, (byte) 0),
        EBAPI.ebStonify(EBAPI.LIMESTONE, (byte) 0) };
