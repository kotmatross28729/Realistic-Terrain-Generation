...
public class SurfaceEBEphemeralLakeEdge extends SurfaceEBBase {
    ...
    public SurfaceEBEphemeralLakeEdge(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
        ...
        for (int k = 255; k > -1; k--) {
            ...
            if (b == Blocks.air) {
                ...
                if (shouldReplaceStone()) {
                    ...
                    metadata[(y * 16 + x) * 256 + k] = EBAPI.ebStonify(EBAPI.SCHIST, hcStoneMeta(world, i, j, x, y, k));
                }
