package rtg.world.gen.surface.sushicraft;
 ...
 */
public class SurfaceSCSakuraForest extends SurfaceBase {
    ...
    public SurfaceSCSakuraForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
