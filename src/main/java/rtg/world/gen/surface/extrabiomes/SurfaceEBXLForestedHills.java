...
public class SurfaceEBXLForestedHills extends SurfaceBase {
    ...
    public SurfaceEBXLForestedHills(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
