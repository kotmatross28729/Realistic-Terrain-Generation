...
public class SurfaceEBBorealPlateauM extends SurfaceEBBase {
    ...
    public SurfaceEBBorealPlateauM(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
