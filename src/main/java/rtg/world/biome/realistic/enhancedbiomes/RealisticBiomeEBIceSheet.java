...
public class RealisticBiomeEBIceSheet extends RealisticBiomeEBBase {
    ...
    public static byte[] ebDominantStoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.DACITE, (byte) 0),
    ...
    public static byte[] ebDominantCobblestoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.DACITE, (byte) 0),
        EBAPI.ebStonify(EBAPI.RHYOLITE, (byte) 0) };
