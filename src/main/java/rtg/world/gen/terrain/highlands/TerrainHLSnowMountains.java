...
public class TerrainHLSnowMountains extends FunctionalTerrainBase {
    ...
    public TerrainHLSnowMountains(float mountainWidth, float mountainStrength) {
        this(mountainWidth, mountainStrength, 90f);
    }

    public TerrainHLSnowMountains(float mountainWidth, float mountainStrength, float baseHeight) {
        width = mountainWidth;
