...
public class NecronomiconCreationRitual extends NecronomiconRitual {
     ...
     */
    public NecronomiconCreationRitual(String unlocalizedName, int bookType, int dimension, float requiredEnergy,
        boolean remnantHelp, ItemStack item, Object... offerings) {
     ...
     * @param offerings       Components used to perform the ritual, are consumed afterwards
     */
    public NecronomiconCreationRitual(String unlocalizedName, int bookType, float requiredEnergy, ItemStack item,
        Object... offerings) {
    ...
    protected void completeRitualServer(World world, int x, int y, int z, EntityPlayer player) {
        ...
        if (ItemStack.loadItemStackFromNBT(nbtItem) == null || !ItemStack.loadItemStackFromNBT(nbtItem)
            .isItemEqual(item)) {
