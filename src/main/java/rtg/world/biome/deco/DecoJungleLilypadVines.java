...
public class DecoJungleLilypadVines extends DecoBase {
     ...
     */
    @Override
    public void generate(RealisticBiomeBase biome, World world, Random rand, int blockX, int blockY,
            ...
            if (TerrainGen.decorate(world, rand, blockX, blockY, LILYPAD)) {
                ...
                for (int b33 = 0; b33 < 5; b33++) {
                    ...
                    for (int h44 = 100; h44 > 0; h44--) {
                        ...
                        if (vb == volcanoBlockId || vb == volcanoMix1BlockId
                            || vb == volcanoMix2BlockId
                            || vb == volcanoMix3BlockId) {
                            return;
                        }
