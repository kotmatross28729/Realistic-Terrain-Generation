...
public class RealisticBiomeSFBase extends RealisticBiomeBase {
    ...
    public RealisticBiomeSFBase(BiomeConfig config, BiomeGenBase b, BiomeGenBase riverbiome, TerrainBase t,
        SurfaceBase s) {
        ...
        if (Loader.isModLoaded("kegare.sugiforest")) {
            ...
            for (int i = 0; i < 256; i++) {
                if (b[i] != null) {
                    ...
                    if (biomeName.equals("Sugi Forest")
                        && biomeClass.equals("com.kegare.sugiforest.world.BiomeGenSugiForest")) {
