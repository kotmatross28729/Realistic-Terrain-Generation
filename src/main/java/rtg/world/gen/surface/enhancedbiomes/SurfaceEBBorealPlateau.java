...
public class SurfaceEBBorealPlateau extends SurfaceEBBase {
    ...
    public SurfaceEBBorealPlateau(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
