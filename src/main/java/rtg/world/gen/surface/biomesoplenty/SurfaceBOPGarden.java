...
public class SurfaceBOPGarden extends SurfaceBase {
    ...
    public SurfaceBOPGarden(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
