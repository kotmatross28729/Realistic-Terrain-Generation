package rtg.world.gen.surface.idt;
...
public class SurfaceIDTSilkwoodForest extends SurfaceBase {
    ...
    public SurfaceIDTSilkwoodForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
