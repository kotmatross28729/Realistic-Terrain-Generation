package rtg.world.gen.surface.sugiforest;
...
public class SurfaceSFSugiForest extends SurfaceBase {
    ...
    public SurfaceSFSugiForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff, Block mix,
        byte mixByte, float mixSize) {
        ...
        mixBlock = this.getConfigBlock(config, BiomeConfigSFSugiForest.surfaceMixBlockId, mix);
        mixBlockMeta = this.getConfigBlockMeta(config, BiomeConfigSFSugiForest.surfaceMixBlockMetaId, mixByte);
        mixHeight = mixSize;
    }
