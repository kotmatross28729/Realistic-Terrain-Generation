...
public class BiomeConfigACDarklandsHighland extends BiomeConfigACBase {
    ...
    public BiomeConfigACDarklandsHighland() {
        super("darklandshighland");
        ...
        this.addProperty(
            new BiomeConfigProperty(surfaceMixFillerBlockId, Type.STRING, surfaceMixFillerBlockName, "", ""));
        this.addProperty(
            new BiomeConfigProperty(surfaceMixFillerBlockMetaId, Type.STRING, surfaceMixFillerBlockMetaName, "", ""));
    }
}
