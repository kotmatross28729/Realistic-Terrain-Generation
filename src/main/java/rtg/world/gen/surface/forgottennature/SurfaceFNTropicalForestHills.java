...
public class SurfaceFNTropicalForestHills extends SurfaceBase {
    ...
    public SurfaceFNTropicalForestHills(BiomeConfig config, Block top, Block fill, boolean genBeach,
