package rtg.world.gen.surface.hotwatermod;
...
public class SurfaceHWMHotSprings extends SurfaceBase {

    public SurfaceHWMHotSprings(BiomeConfig config, Block top, Block filler) {
