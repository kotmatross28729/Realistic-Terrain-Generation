...
public class SurfaceEBCreekBed extends SurfaceEBBase {
    ...
    public SurfaceEBCreekBed(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
