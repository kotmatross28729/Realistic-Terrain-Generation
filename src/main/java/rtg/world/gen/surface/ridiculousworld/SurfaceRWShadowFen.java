...
public class SurfaceRWShadowFen extends SurfaceBase {
    ...
    public SurfaceRWShadowFen(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
        byte mixTopByte, Block mixFiller, byte mixFillerByte, float mixWidth, float mixHeight, float smallWidth,
        float smallStrength) {
