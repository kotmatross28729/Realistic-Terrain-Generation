...
public class SurfaceEBSnowyPlateau extends SurfaceEBBase {
    ...
    public SurfaceEBSnowyPlateau(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
