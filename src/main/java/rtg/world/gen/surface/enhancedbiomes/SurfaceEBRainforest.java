...
public class SurfaceEBRainforest extends SurfaceEBBase {
    ...
    public SurfaceEBRainforest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
