...
public class SurfaceEBXLMountainDesert extends SurfaceBase {
    ...
    public SurfaceEBXLMountainDesert(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
