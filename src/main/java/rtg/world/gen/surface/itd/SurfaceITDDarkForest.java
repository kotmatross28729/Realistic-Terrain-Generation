package rtg.world.gen.surface.itd;
...
public class SurfaceITDDarkForest extends SurfaceBase {
    ...
    public SurfaceITDDarkForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
