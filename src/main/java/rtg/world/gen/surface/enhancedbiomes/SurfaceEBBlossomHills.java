...
public class SurfaceEBBlossomHills extends SurfaceEBBase {
    ...
    public SurfaceEBBlossomHills(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
