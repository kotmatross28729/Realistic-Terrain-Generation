...
public class SurfaceBOPAlpsForest extends SurfaceBase {
    ...
    public SurfaceBOPAlpsForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
