...
public class SurfaceEBDesertArchipelago extends SurfaceEBBase {
    ...
    public SurfaceEBDesertArchipelago(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
