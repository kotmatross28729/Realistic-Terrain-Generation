...
public class SurfaceIDTEbonyForest extends SurfaceBase {
    ...
    public SurfaceIDTEbonyForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
