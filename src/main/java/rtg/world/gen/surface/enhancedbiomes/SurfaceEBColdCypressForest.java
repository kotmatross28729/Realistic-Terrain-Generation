...
public class SurfaceEBColdCypressForest extends SurfaceEBBase {
    ...
    public SurfaceEBColdCypressForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
