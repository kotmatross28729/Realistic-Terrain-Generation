...
public class SurfaceHLWoodlands extends SurfaceBase {
    ...
    public SurfaceHLWoodlands(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
