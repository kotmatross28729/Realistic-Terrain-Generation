...
public class SurfaceEBColdFirForest extends SurfaceEBBase {
    ...
    public SurfaceEBColdFirForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
