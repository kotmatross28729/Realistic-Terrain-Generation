...
public class SurfaceEBSnowyDesert extends SurfaceEBBase {
    ...
    public SurfaceEBSnowyDesert(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
        ...
        for (int k = 255; k > -1; k--) {
            ...
            if (b == Blocks.air) {
                ...
                if (shouldReplaceStone()) {
                    ...
                    metadata[(y * 16 + x) * 256 + k] = EBAPI.ebStonify(EBAPI.DACITE, hcStoneMeta(world, i, j, x, y, k));
                }
