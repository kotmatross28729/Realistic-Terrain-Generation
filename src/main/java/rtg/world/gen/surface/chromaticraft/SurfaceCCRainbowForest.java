package rtg.world.gen.surface.chromaticraft;
...
public class SurfaceCCRainbowForest extends SurfaceBase {
    ...
    public SurfaceCCRainbowForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff, Block mixBlock,
        float mixSize) {
