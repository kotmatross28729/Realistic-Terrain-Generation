...
public class SurfaceEBGrassyArchipelago extends SurfaceEBBase {
    ...
    public SurfaceEBGrassyArchipelago(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
