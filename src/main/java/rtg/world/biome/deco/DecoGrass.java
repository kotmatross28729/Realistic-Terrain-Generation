...
public class DecoGrass extends DecoBase {
    ...
    public DecoGrass() {
        ...
        this.strengthFactor = 0f; // Not sure why it was done like this, but... the higher the value, the more there
                                  // will be.
        this.loops = 1;
        this.chance = 1;
        ...
        this.useRandomGrass = (this.randomGrassBlocks.length > 0
            && this.randomGrassBlocks.length == this.randomGrassMetas.length);
