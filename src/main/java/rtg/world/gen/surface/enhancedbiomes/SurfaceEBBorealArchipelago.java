...
public class SurfaceEBBorealArchipelago extends SurfaceEBBase {
    ...
    public SurfaceEBBorealArchipelago(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
