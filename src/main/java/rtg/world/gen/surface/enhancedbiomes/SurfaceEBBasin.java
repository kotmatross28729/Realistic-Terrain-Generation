...
public class SurfaceEBBasin extends SurfaceEBBase {
    ...
    public SurfaceEBBasin(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
