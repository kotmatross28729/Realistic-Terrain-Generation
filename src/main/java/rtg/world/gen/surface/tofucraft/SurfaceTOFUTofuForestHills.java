...
public class SurfaceTOFUTofuForestHills extends SurfaceBase {
    ...
    public SurfaceTOFUTofuForestHills(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
