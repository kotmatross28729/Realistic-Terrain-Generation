...
public class SurfaceEBColdPineForest extends SurfaceEBBase {
    ...
    public SurfaceEBColdPineForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
