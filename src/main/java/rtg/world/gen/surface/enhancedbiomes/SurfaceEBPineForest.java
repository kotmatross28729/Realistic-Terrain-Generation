...
public class SurfaceEBPineForest extends SurfaceEBBase {
    ...
    public SurfaceEBPineForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
