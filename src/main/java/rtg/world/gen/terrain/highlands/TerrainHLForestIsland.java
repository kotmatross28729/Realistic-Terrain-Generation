...
public class TerrainHLForestIsland extends TerrainBase {
     ...
     */
    public TerrainHLForestIsland(float hillHeight, float hillWidth, float varHeight, float varWidth, float lakeHeight,
