...
public class TerrainECCHighLands extends TerrainBase {
    ...
    public float generateNoise(OpenSimplexNoise simplex, CellNoise cell, int x, int y, float border, float river) {
        return riverized(
            baseHeight + withJitter.added(simplex, cell, x, y) + this.groundNoise(x, y, 6, simplex),
            river);
