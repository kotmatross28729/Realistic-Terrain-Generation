...
public class SurfaceVanillaExtremeHills extends SurfaceBase {
    ...
    public SurfaceVanillaExtremeHills(BiomeConfig config, Block top, Block filler, Block mixTop, Block mixFill,
        ...
        mixBlockTopMeta = this
            .getConfigBlockMeta(config, BiomeConfigVanillaExtremeHills.surfaceMixBlockMetaId, (byte) 0);
        ...
        mixBlockFillMeta = this
            .getConfigBlockMeta(config, BiomeConfigVanillaExtremeHills.surfaceMixFillerBlockMetaId, (byte) 0);
