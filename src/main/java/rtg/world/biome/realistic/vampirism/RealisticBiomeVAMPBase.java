...
public class RealisticBiomeVAMPBase extends RealisticBiomeBase {
    ...
    public RealisticBiomeVAMPBase(BiomeConfig config, BiomeGenBase b, BiomeGenBase riverbiome, TerrainBase t,
        SurfaceBase s) {
        ...
        if (Loader.isModLoaded("vampirism")) {
            ...
            for (int i = 0; i < 256; i++) {
                if (b[i] != null) {
                    ...
                    if (biomeName == "vampireForest"
                        && biomeClass == "de.teamlapen.vampirism.biome.BiomeVampireForest") {
                        vampVampireForest = new RealisticBiomeVAMPVampireForest(
                            vampBiome,
                            BiomeConfigVAMP.biomeConfigVAMPVampireForest);
                    }
                }
            }
        }
