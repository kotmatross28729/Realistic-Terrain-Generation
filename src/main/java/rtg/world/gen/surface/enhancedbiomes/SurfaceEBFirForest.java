...
public class SurfaceEBFirForest extends SurfaceEBBase {
    ...
    public SurfaceEBFirForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
