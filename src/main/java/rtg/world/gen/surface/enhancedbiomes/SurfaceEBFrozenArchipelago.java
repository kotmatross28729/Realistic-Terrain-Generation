...
public class SurfaceEBFrozenArchipelago extends SurfaceEBBase {
    ...
    public SurfaceEBFrozenArchipelago(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
