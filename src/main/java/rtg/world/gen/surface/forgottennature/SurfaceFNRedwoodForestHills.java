...
public class SurfaceFNRedwoodForestHills extends SurfaceBase {
    ...
    public SurfaceFNRedwoodForestHills(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
