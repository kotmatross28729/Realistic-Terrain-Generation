...
public class SurfaceEBMarsh extends SurfaceEBBase {
    ...
    public SurfaceEBMarsh(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
