...
public class SurfaceHLRockMountains extends SurfaceBase {
    ...
    public SurfaceHLRockMountains(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
