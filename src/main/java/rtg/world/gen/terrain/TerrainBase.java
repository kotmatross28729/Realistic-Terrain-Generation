...
public class TerrainBase {
    ...
    public static final float minimumDuneHeight = 21f; // The strength factor to which the dune height config option is
                                                       // added.
    ...
    public static float hills(float x, float y, float hillStrength, OpenSimplexNoise simplex, float river) {
        ...
        float sm = simplex.octave(2)
            .noise2(x / 55, y / 55);// there are artifacts if this is close to a multiple of 16
    ...
    public static float groundNoise(int x, int y, float amplitude, OpenSimplexNoise simplex) {
        ...
        h += blendedHillHeight(
            simplex.octave(1)
                .noise2((float) x / 23f, (float) y / 23f),
            0.2f) * amplitude / 2f;
        h += blendedHillHeight(
            simplex.octave(2)
                .noise2((float) x / 11f, (float) y / 11f),
            0.2f) * amplitude / 4f;
        return h;
    }
    ...
    public static float terrainBeach(int x, int y, OpenSimplexNoise simplex, float river, float pitch1, float pitch2,
        float baseHeight) {
    ...
    public static float terrainCanyon(int x, int y, OpenSimplexNoise simplex, float river, float[] height, float border,
        float strength, int heightLength, boolean booRiver) {
    ...
    public static float terrainDuneValley(float x, float y, OpenSimplexNoise simplex, CellNoise cell, float river,
        float valley, float hFactor, float baseHeight) {
    ...
    public static float terrainFlatLakes(int x, int y, OpenSimplexNoise simplex, float river, float hMax,
        float baseHeight) {
        /*
        ...
        float ruggedNoise = simplex.octave(1)
            .noise2(
    ...
    public static float terrainGrasslandFlats(int x, int y, OpenSimplexNoise simplex, float river, float mPitch,
        float lPitch, float baseHeight) {
    ...
    public static float terrainGrasslandHills(int x, int y, OpenSimplexNoise simplex, CellNoise cell, float river,
        ...
        float m = simplex.octave(1)
            .noise2(x / hWidth, y / hWidth);
    ...
    public static float terrainGrasslandMountains(int x, int y, OpenSimplexNoise simplex, CellNoise cell, float river,
        ...
        float c = (float) simplex.octave(4)
            .noise(x / 30f, y / 30f, 1D) * (m * 0.30f);
    ...
    public static float terrainHighland(float x, float y, OpenSimplexNoise simplex, CellNoise cell, float river,
        ...
        if (h > 0f) {
            ...
            h += simplex.octave(4)
                .noise(x / 70D, y / 70D, 1D) * st;// 0 to 155
            h = h * river;
        }
    ...
    public static float terrainLonelyMountain(int x, int y, OpenSimplexNoise simplex, CellNoise cell, float river,
    ...
    public static float terrainMountainSpikes(int x, int y, OpenSimplexNoise simplex, CellNoise cell, float river) {
        ...
        float h = (float) simplex.octave(4)
            .noise(x / 200D, y / 200D, 1D) * b * river;
        h *= h * 1.5f;
        h = h > 155f ? 155f : h;
    ...
    public static float terrainOceanCanyon(int x, int y, OpenSimplexNoise simplex, float river, float[] height,
        float border, float strength, int heightLength, boolean booRiver) {
        // float b = simplex.noise2(x / cWidth, y / cWidth) * cHeigth * river;
        // b *= b / cStrength;
        river *= 1.3f;
        river = river > 1f ? 1f : river;
    ...
    public static float terrainPlains(int x, int y, OpenSimplexNoise simplex, float river, float stPitch,
    ...
    public static float terrainPlateau(float x, float y, OpenSimplexNoise simplex, float river, float[] height,
        float border, float strength, int heightLength, float selectorWaveLength, boolean isM) {
        river = river > 1f ? 1f : river;
    ...
    public static float terrainPolar(float x, float y, OpenSimplexNoise simplex, float river, float stPitch,
        float stFactor, float hPitch, float hDivisor, float baseHeight) {
        float floNoise;
        float st = (simplex.noise2(x / stPitch, y / stPitch) + 0.38f) * stFactor * river;
        st = st < 0.1f ? 0.1f : st;
    ...
    public static float terrainRollingHills(int x, int y, OpenSimplexNoise simplex, float river, float hillStrength,
        float addedHeight, float groundNoise, float groundNoiseAmplitudeHills, float lift) {
    ...
    public static float terrainRollingHills(int x, int y, OpenSimplexNoise simplex, float river, float hillStrength,
        float groundNoise, float groundNoiseAmplitudeHills, float baseHeight) {
        groundNoise = groundNoise(x, y, groundNoiseAmplitudeHills, simplex);
    ...
    public static float terrainSwampMountain(int x, int y, OpenSimplexNoise simplex, CellNoise cell, float river,
        float width, float heigth, float hMax, float hDivisor, float baseHeight) {
    ...
    public static float terrainVolcano(int x, int y, OpenSimplexNoise simplex, CellNoise cell, float border,
        float baseHeight) {
