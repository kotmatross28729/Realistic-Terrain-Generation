...
public class SurfaceHLFlyingMountains extends SurfaceBase {
    ...
    public SurfaceHLFlyingMountains(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
