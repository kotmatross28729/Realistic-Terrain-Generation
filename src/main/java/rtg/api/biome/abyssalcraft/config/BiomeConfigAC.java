...
public class BiomeConfigAC {
    ...
    public static BiomeConfig[] getBiomeConfigs() {
        BiomeConfig[] biomeConfigs = new BiomeConfig[] { biomeConfigACCoraliumInfestedSwamp, biomeConfigACDarklands,
            biomeConfigACDarklandsForest, biomeConfigACDarklandsHighland, biomeConfigACDarklandsMountains,
