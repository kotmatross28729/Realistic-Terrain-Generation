...
public class SurfaceEBSandstoneCanyon2 extends SurfaceEBBase {
    ...
    public SurfaceEBSandstoneCanyon2(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
            ...
            if (b == Blocks.air) {
                ...
                if (shouldReplaceStone()) {
                    ...
                    metadata[(y * 16 + x) * 256 + k] = EBAPI
                        .ebStonify(EBAPI.HARDENED_SANDSTONE, hcStoneMeta(world, i, j, x, y, k));
                }
