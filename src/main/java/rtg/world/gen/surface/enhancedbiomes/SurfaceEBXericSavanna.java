...
public class SurfaceEBXericSavanna extends SurfaceEBBase {
    ...
    public SurfaceEBXericSavanna(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
