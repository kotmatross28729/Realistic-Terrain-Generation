...
public class SurfaceEBBorealForest extends SurfaceEBBase {
    ...
    public SurfaceEBBorealForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
