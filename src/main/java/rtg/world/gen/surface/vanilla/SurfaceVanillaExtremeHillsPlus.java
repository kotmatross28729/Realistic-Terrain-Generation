...
public class SurfaceVanillaExtremeHillsPlus extends SurfaceBase {
    ...
    public SurfaceVanillaExtremeHillsPlus(BiomeConfig config, Block top, Block fill, boolean genBeach,
        ...
        mixBlock = this.getConfigBlock(config, BiomeConfigVanillaExtremeHillsPlus.surfaceMixBlockId, mix);
        mixBlockMeta = this
            .getConfigBlockMeta(config, BiomeConfigVanillaExtremeHillsPlus.surfaceMixBlockMetaId, (byte) 0);
        mixHeight = mixSize;
    }
