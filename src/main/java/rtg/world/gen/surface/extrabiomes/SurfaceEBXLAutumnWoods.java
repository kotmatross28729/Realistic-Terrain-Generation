...
public class SurfaceEBXLAutumnWoods extends SurfaceBase {
    ...
    public SurfaceEBXLAutumnWoods(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff, Block mixBlock,
        byte pByte, float mixSize) {
