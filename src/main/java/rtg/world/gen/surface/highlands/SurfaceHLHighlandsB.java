...
public class SurfaceHLHighlandsB extends SurfaceBase {
    ...
    public SurfaceHLHighlandsB(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
