...
public class SurfaceEBWoodlandLakeEdge extends SurfaceEBBase {
    ...
    public SurfaceEBWoodlandLakeEdge(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
