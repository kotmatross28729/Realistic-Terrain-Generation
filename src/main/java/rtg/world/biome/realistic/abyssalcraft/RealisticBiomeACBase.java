...
public class RealisticBiomeACBase extends RealisticBiomeBase {
    ...
    public RealisticBiomeACBase(BiomeConfig config, BiomeGenBase b, BiomeGenBase riverbiome, TerrainBase t,
        SurfaceBase s) {
        ...
        if (Loader.isModLoaded("abyssalcraft")) {
            if (ACBiomes.coralium_infested_swamp != null)
                acCoraliumInfestedSwamp = new RealisticBiomeACCoraliumInfestedSwamp(
                    BiomeConfigAC.biomeConfigACCoraliumInfestedSwamp);
            ...
            if (ACBiomes.darklands_hills != null) acDarklandsHighland = new RealisticBiomeACDarklandsHighland(
                BiomeConfigAC.biomeConfigACDarklandsHighland);
            if (ACBiomes.darklands_mountains != null) acDarklandsMountains = new RealisticBiomeACDarklandsMountains(
                BiomeConfigAC.biomeConfigACDarklandsMountains);
