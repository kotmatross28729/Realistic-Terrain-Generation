...
public class NecronomiconSummonRitual extends NecronomiconRitual {
     ...
     */
    public NecronomiconSummonRitual(String unlocalizedName, int bookType, int dimension, float requiredEnergy,
        boolean remnantHelp, Class<? extends EntityLivingBase> entity, Object... offerings) {
     ...
     */
    public NecronomiconSummonRitual(String unlocalizedName, int bookType, int dimension, float requiredEnergy,
        Class<? extends EntityLivingBase> entity, Object... offerings) {
     ...
     * @param offerings       Components used to perform the ritual, are consumed afterwards
     */
    public NecronomiconSummonRitual(String unlocalizedName, int bookType, float requiredEnergy,
        Class<? extends EntityLivingBase> entity, Object... offerings) {
    ...
    protected void completeRitualServer(World world, int x, int y, int z, EntityPlayer player) {
        ...
        try {
            entityliving = entity.getConstructor(World.class)
                .newInstance(world);
