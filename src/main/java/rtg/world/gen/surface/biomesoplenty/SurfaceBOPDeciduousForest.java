...
public class SurfaceBOPDeciduousForest extends SurfaceBase {
    ...
    public SurfaceBOPDeciduousForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
        Block mixTop, byte mixTopByte, Block mixFiller, byte mixFillerByte, float mixWidth, float mixHeight,
