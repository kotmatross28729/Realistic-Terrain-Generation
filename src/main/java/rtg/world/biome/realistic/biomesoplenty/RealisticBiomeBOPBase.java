...
public class RealisticBiomeBOPBase extends RealisticBiomeBase {
    ...
    public RealisticBiomeBOPBase(BiomeConfig config, BiomeGenBase b, BiomeGenBase riverbiome, TerrainBase t,
        SurfaceBase s) {
    ...
    public static void addBiomes() {
        if (Loader.isModLoaded("BiomesOPlenty")) {
            ...
            if (BOPCBiomes.cherryBlossomGrove != null) bopCherryBlossomGrove = new RealisticBiomeBOPCherryBlossomGrove(
                BiomeConfigBOP.biomeConfigBOPCherryBlossomGrove);
            if (BOPCBiomes.coniferousForest != null) bopConiferousForest = new RealisticBiomeBOPConiferousForest(
                BiomeConfigBOP.biomeConfigBOPConiferousForest);
            if (BOPCBiomes.snowyConiferousForest != null)
                bopSnowyConiferousForest = new RealisticBiomeBOPSnowyConiferousForest(
                    BiomeConfigBOP.biomeConfigBOPSnowyConiferousForest);
            ...
            try {
                if (BOPCBiomes.denseForest != null)
                    bopDenseForest = new RealisticBiomeBOPDenseForest(BiomeConfigBOP.biomeConfigBOPDenseForest);
                if (BOPCBiomes.eucalyptusForest != null) bopEucalyptusForest = new RealisticBiomeBOPEucalyptusForest(
                    BiomeConfigBOP.biomeConfigBOPEucalyptusForest);
            ...
            try {
                if (BOPCBiomes.landOfLakes != null)
            ...
            if (BOPCBiomes.temperateRainforest != null)
                bopTemperateRainforest = new RealisticBiomeBOPTemperateRainforest(
                    BiomeConfigBOP.biomeConfigBOPTemperateRainforest);
            if (BOPCBiomes.thicket != null)
                bopThicket = new RealisticBiomeBOPThicket(BiomeConfigBOP.biomeConfigBOPThicket);
            if (BOPCBiomes.tropicalRainforest != null) bopTropicalRainforest = new RealisticBiomeBOPTropicalRainforest(
                BiomeConfigBOP.biomeConfigBOPTropicalRainforest);
            ...
            try {
                if (BOPCBiomes.xericShrubland != null) bopXericShrubland = new RealisticBiomeBOPXericShrubland(
                    BiomeConfigBOP.biomeConfigBOPXericShrubland);
            } catch (NoSuchFieldError e) {
                olderBoP = true;
            }
            ...
            try {
                if (BOPCBiomes.landOfLakesMarsh != null) bopLandOfLakesMarsh = new RealisticBiomeBOPLandOfLakesMarsh(
                    BiomeConfigBOP.biomeConfigBOPLandOfLakesMarsh);
            } catch (NoSuchFieldError e) {
                olderBoP = true;
            }
            ...
            try {
                if (BOPCBiomes.seasonalForestClearing != null)
                    bopSeasonalForestClearing = new RealisticBiomeBOPSeasonalForestClearing(
                        BiomeConfigBOP.biomeConfigBOPSeasonalForestClearing);
            } catch (NoSuchFieldError e) {
                olderBoP = true;
            }
