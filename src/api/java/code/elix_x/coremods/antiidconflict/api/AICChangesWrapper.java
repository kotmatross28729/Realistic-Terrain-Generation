 ...
 * Methods here should be used instead of vanilla's, when AIC is loaded, or otherwise your calls to vanilla methods will
 * be redirected and voided to not cause any crashes.
 * <br>
...
public class AICChangesWrapper {
     ...
     * <br>
     * Note: this will also return false, if AIC is not loaded. So to make compatibility on biome part with AIC, you can
     * use this method without additionally calling {@link #isAICLoaded()}.
     * 
