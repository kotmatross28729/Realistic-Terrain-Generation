...
public class MapGenCavesRTG extends MapGenCaves {
    ...
    @Override
    protected void func_151542_a(long rtgSeed, int p_151542_3_, int p_151542_4_, Block[] p_151542_5_,
    ...
    @Override
    protected void func_151541_a(long rtgSeed, int chunkX, int chunkZ, Block[] blocks, double p_151541_6_,
        double p_151541_8_, double p_151541_10_, float p_151541_12_, float p_151541_13_, float p_151541_14_,
        int p_151541_15_, int p_151541_16_, double p_151541_17_) {
        ...
        for (boolean flag = random.nextInt(6) == 0; p_151541_15_ < p_151541_16_; ++p_151541_15_) {
            double d6 = 1.5D
                + (double) (MathHelper.sin((float) p_151541_15_ * (float) Math.PI / (float) p_151541_16_) * p_151541_12_
                    * 1.0F);
            ...
            if (flag2 || random.nextInt(4) != 0) {
                ...
                if (p_151541_6_ >= d4 - 16.0D - d6 * 2.0D && p_151541_10_ >= d5 - 16.0D - d6 * 2.0D
                    && p_151541_6_ <= d4 + 16.0D + d6 * 2.0D
                    && p_151541_10_ <= d5 + 16.0D + d6 * 2.0D) {
    ...
    @Override
    protected void func_151538_a(World world, int chunkX, int chunkZ, int p_151538_4_, int p_151538_5_,
        Block[] p_151538_6_) {
        ...
        BiomeGenBase biome = world
            .getBiomeGenForCoords(this.rand.nextInt(16) + chunkX * 16, this.rand.nextInt(16) + chunkZ * 16);
        ...
        if (biome != null) {
            ...
            if (realisticBiome != null) {
                caveDensity = (realisticBiome.config._int(BiomeConfig.caveDensityId) > -1)
                    ? realisticBiome.config._int(BiomeConfig.caveDensityId)
                    : caveDensity;
                caveFrequency = (realisticBiome.config._int(BiomeConfig.caveFrequencyId) > -1)
                    ? realisticBiome.config._int(BiomeConfig.caveFrequencyId)
                    : caveFrequency;
            }
        }
