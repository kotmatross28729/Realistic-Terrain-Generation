...
public class SurfaceBOPFungiForest extends SurfaceBase {
    ...
    public SurfaceBOPFungiForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
