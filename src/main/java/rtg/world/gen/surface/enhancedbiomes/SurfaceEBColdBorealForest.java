...
public class SurfaceEBColdBorealForest extends SurfaceEBBase {
    ...
    public SurfaceEBColdBorealForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
