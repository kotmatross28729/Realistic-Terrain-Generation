...
public class IMCHelper {
     ...
     * FMLInterModComms.sendMessage("abyssalcraft", "shoggothFood",
     * "com.shinoow.abyssalcraft.common.entity.EntityDepthsGhoul");
     */
     ...
     * FMLInterModComms.sendMessage("abyssalcraft", "registerTransmutatorFuel",
     * "com.shinoow.abyssalcraft.common.handlers.FurnaceFuelHandler");
     */
     ...
     * FMLInterModComms.sendMessage("abyssalcraft", "registerCrystallizerFuel",
     * "com.shinoow.abyssalcraft.common.handlers.FurnaceFuelHandler");
     */
     ...
     * "addOredictSingleCrystallization" - used for single-output OreDictinoary crystallization with only 1 ItemStack
     * output
     * 
     * The IMC message should contain a NBTTagCompound with the following tags:
     * "input" - the input, should be a ItemStack unless it's a OreDictionary recipe, in which case it should be a
     * String
     ...
     * "quantity1" (optional) - quantity of the first output, will null any metadata if used without the "meta1" tag.
     * Used for normal crystallization
     * "quantity2" (optional) - quantity of the second output, will null any metadata if used without the "meta2" tag.
     * Used for normal crystallization
     * "quantity" (optional) - quantity of the output, will null any metadata if used without the "meta" tag. Used for
     ...
     * FMLInterModComms.sendMessage("abyssalcraft", <whichever message you picked>, <a NBTTagCompound with the
     * aforementioned tags>);
     */
     ...
     * 
     * The message is sent this way:
     * FMLInterModComms.sendMessage("abyssalcraft", "addMaterialization", <a NBTTagCompound with the aforementioned
     * tags>);
     */
