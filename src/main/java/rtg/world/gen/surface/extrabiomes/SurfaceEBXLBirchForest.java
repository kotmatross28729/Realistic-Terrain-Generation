...
public class SurfaceEBXLBirchForest extends SurfaceBase {
    ...
    public SurfaceEBXLBirchForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
