...
public class TerrainEBSandstoneCanyon2 extends TerrainBase {
     ...
     */
    public TerrainEBSandstoneCanyon2(boolean riverGen, float heightStrength, float canyonWidth, float canyonHeight,
