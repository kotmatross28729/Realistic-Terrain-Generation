...
public class SurfaceFNTropicalForest extends SurfaceBase {
    ...
    public SurfaceFNTropicalForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
