...
public class SurfaceEBMountainsEdge extends SurfaceEBBase {
    ...
    public SurfaceEBMountainsEdge(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
