...
public class SurfaceVanillaJungle extends SurfaceBase {
    ...
    public SurfaceVanillaJungle(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        ...
        mixBlock = this.getConfigBlock(config, BiomeConfigVanillaJungle.surfaceMixBlockId, mix);
        mixBlockMeta = this.getConfigBlockMeta(config, BiomeConfigVanillaJungle.surfaceMixBlockMetaId, mixByte);
        mixHeight = mixSize;
    }
