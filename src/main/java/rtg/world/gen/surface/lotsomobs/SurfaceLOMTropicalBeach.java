...
public class SurfaceLOMTropicalBeach extends SurfaceBase {
    ...
    public SurfaceLOMTropicalBeach(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
