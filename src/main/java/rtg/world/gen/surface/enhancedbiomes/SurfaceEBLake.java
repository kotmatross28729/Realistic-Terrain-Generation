...
public class SurfaceEBLake extends SurfaceEBBase {
    ...
    public SurfaceEBLake(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
