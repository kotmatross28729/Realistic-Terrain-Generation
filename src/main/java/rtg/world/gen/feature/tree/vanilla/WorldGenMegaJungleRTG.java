...
public class WorldGenMegaJungleRTG extends WorldGenMegaJungle {
    ...
    public WorldGenMegaJungleRTG(boolean doBlockNotify, int minTrunkHeight, int maxTrunkHeight, int minCrownHeight,
        int maxCrownHeight, int logMeta, int leavesMeta) {
    ...
    public boolean generate(World world, Random rand, int worldX, int worldY, int worldZ) {
        ...
        if (!this.func_150537_a(world, rand, worldX, worldY, worldZ, treeHeight)) {
            ...
            for (int i1 = worldY + treeHeight - 2 - rand.nextInt(4); i1
                > worldY + treeHeight / 2; i1 -= 2 + rand.nextInt(4)) {
            ...
            for (int l2 = 0; l2 < treeHeight; ++l2) {
                ...
                if (block.isAir(world, worldX, worldY + l2, worldZ)
                    || block.isLeaves(world, worldX, worldY + l2, worldZ)) {
                ...
                if (l2 < treeHeight - 1) {
                    ...
                    if (block.isAir(world, worldX + 1, worldY + l2, worldZ)
                        || block.isLeaves(world, worldX + 1, worldY + l2, worldZ)) {
                    ...
                    if (block.isAir(world, worldX + 1, worldY + l2, worldZ + 1)
                        || block.isLeaves(world, worldX + 1, worldY + l2, worldZ + 1)) {
                        this.setBlockAndNotifyAdequately(
                            world,
                            worldX + 1,
                            worldY + l2,
                    ...
                    if (block.isAir(world, worldX, worldY + l2, worldZ + 1)
                        || block.isLeaves(world, worldX, worldY + l2, worldZ + 1)) {
                        this.setBlockAndNotifyAdequately(
                            world,
                            worldX,
                            worldY + l2,
