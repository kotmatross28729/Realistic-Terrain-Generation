...
public class SurfaceVanillaExtremeHillsPlusM extends SurfaceBase {
    ...
    public SurfaceVanillaExtremeHillsPlusM(BiomeConfig config, Block top, Block fill, boolean genBeach,
        Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff,
        Block mix, float mixSize) {
        ...
        mixBlock = this.getConfigBlock(config, BiomeConfigVanillaExtremeHillsPlusM.surfaceMixBlockId, mix);
        mixBlockMeta = this
            .getConfigBlockMeta(config, BiomeConfigVanillaExtremeHillsPlusM.surfaceMixBlockMetaId, (byte) 0);
        mixHeight = mixSize;
    }
