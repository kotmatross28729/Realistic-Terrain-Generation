...
public class BiomeConfigVanillaIcePlainsSpikes extends BiomeConfigVanillaBase {
    ...
    public BiomeConfigVanillaIcePlainsSpikes() {
        ...
        this.addProperty(
            new BiomeConfigProperty(decorationIceTreesId, Type.BOOLEAN, decorationIceTreesName, "", false));
        this.addProperty(
            new BiomeConfigProperty(decorationIceShrubsId, Type.BOOLEAN, decorationIceShrubsName, "", false));
        this.addProperty(
