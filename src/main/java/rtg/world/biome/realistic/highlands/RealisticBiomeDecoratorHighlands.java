...
public class RealisticBiomeDecoratorHighlands extends BiomeDecorator {
    ...
    //
    // public RealisticBiomeDecoratorHighlands(BiomeGenBase par1BiomeGenBase, int trees, int grass, int flowers, int
    // hlPlants) {
    // super();
    ...
    // }
    //
    // public void genOreHighlands(World world, Random random, int x, int z, int timesPerChunk, WorldGenerator oreGen,
    // int minH, int maxH) {
    ...
    // }
    // }
    // public void genOreHighlandsNoCheck(World world, Random random, int locX, int locZ, int timesPerChunk,
    // WorldGenerator oreGen, int minH, int maxH)
    // {
    // for (int var5 = 0; var5 < timesPerChunk; ++var5)
    // {
