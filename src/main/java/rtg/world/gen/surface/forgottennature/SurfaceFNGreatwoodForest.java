...
public class SurfaceFNGreatwoodForest extends SurfaceBase {
    ...
    public SurfaceFNGreatwoodForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
