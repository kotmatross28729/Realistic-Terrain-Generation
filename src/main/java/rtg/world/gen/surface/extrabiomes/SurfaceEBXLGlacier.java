...
public class SurfaceEBXLGlacier extends SurfaceBase {
    ...
    public SurfaceEBXLGlacier(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
