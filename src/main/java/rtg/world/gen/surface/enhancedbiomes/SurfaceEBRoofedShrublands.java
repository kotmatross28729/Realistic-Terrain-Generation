...
public class SurfaceEBRoofedShrublands extends SurfaceEBBase {
    ...
    public SurfaceEBRoofedShrublands(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
