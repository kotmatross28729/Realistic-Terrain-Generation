...
public class SurfaceEBPlateau extends SurfaceEBBase {
    ...
    public SurfaceEBPlateau(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
