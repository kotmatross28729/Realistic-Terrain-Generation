...
public class SurfaceEBPineForestArchipelago extends SurfaceEBBase {
    ...
    public SurfaceEBPineForestArchipelago(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
        Block mixTop, byte mixTopByte, Block mixFiller, byte mixFillerByte, Block cliff1, byte cliff1Byte, Block cliff2,
        byte cliff2Byte, float mixWidth, float mixHeight, float smallWidth, float smallStrength) {
                ...
                if (cliff) {
                    ...
                    if (depth == 0 && k > 61) {
                        if (simplex.noise2(i / floMixWidth, j / floMixWidth)
                            + simplex.noise2(i / floSmallWidth, j / floSmallWidth) * floSmallStrength > floMixHeight) {
