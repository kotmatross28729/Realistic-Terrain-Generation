...
public class SurfaceHLTallPineForest extends SurfaceBase {
    ...
    public SurfaceHLTallPineForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
