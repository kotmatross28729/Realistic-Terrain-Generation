...
public class SurfaceTOFUTofuForest extends SurfaceBase {
    ...
    public SurfaceTOFUTofuForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
