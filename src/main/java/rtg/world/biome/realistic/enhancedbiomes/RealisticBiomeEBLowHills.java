...
public class RealisticBiomeEBLowHills extends RealisticBiomeEBBase {
    ...
    public static Block[] ebDominantStoneBlock = new Block[] { EBAPI.ebStonify(Blocks.stone, Blocks.stone),
        EBAPI.ebStonify(Blocks.stone, Blocks.stone) };

    public static byte[] ebDominantStoneMeta = new byte[] { EBAPI.ebStonify((byte) 0, (byte) 0),
    ...
    public static byte[] ebDominantCobblestoneMeta = new byte[] { EBAPI.ebStonify((byte) 0, (byte) 0),
        EBAPI.ebStonify((byte) 0, (byte) 0) };
    ...
    public RealisticBiomeEBLowHills(BiomeGenBase ebBiome, BiomeConfig config) {
        super(
            config,
            ebBiome,
            BiomeGenBase.river,
            new TerrainEBLowHills(),
            new SurfaceEBLowHills(
                config,
