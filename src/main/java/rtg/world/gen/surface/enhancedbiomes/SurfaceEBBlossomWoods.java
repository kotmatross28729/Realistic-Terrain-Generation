...
public class SurfaceEBBlossomWoods extends SurfaceEBBase {
    ...
    public SurfaceEBBlossomWoods(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
