...
public class SimplexCellularOctave implements CellOctave {
    ...
    public SimplexCellularOctave(long seed) {
        ...
        for (short i = 0; i < 1024; i++) source[i] = i;
    ...
    // 2D Points: Dodecagon
    private static final double[] JITTER_2D = new double[] { 0, 0.408248290463863, 0.204124145231932, 0.353553390593274,
        0.353553390593274, 0.204124145231932, 0.408248290463863, 0, 0.353553390593274, -0.204124145231932,
        0.204124145231932, -0.353553390593274, 0, -0.408248290463863, -0.204124145231932, -0.353553390593274,
        -0.353553390593274, -0.204124145231932, -0.408248290463863, 0, -0.353553390593274, 0.204124145231932,
