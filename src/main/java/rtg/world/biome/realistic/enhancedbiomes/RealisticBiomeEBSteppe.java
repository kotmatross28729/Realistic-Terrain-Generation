...
public class RealisticBiomeEBSteppe extends RealisticBiomeEBBase {
    ...
    public static byte[] ebDominantStoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.CHALK, (byte) 0),
    ...
    public static byte[] ebDominantCobblestoneMeta = new byte[] { EBAPI.ebStonify(EBAPI.CHALK, (byte) 0),
        EBAPI.ebStonify(EBAPI.CHALK, (byte) 0) };
    ...
    public RealisticBiomeEBSteppe(BiomeGenBase ebBiome, BiomeConfig config) {
        ...
        Block[] randomGrassBlocks = new Block[] { Blocks.double_plant, Blocks.tallgrass, Blocks.double_plant,
            Blocks.tallgrass };
