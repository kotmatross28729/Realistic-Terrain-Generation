...
public class SurfaceEBOasis extends SurfaceEBBase {
    ...
    public SurfaceEBOasis(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
