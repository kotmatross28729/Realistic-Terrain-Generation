...
public class SurfaceEBPrairie extends SurfaceEBBase {
    ...
    public SurfaceEBPrairie(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
