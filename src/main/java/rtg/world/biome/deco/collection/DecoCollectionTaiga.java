...
public class DecoCollectionTaiga extends DecoCollectionBase {
    ...
    public DecoCollectionTaiga(boolean fallenTrees, float grassStrengthFactor) {
        ...
        DecoHelperThisOrThat decoHelperThisOrThat1 = new DecoHelperThisOrThat(
            4,
        ...
        DecoHelperThisOrThat decoHelperThisOrThat2 = new DecoHelperThisOrThat(
            4,
            ChanceType.NOT_EQUALS_ZERO,
            bigSpruceTrees2,
            bigSpruceOakTrees2);
        ...
        DecoHelperThisOrThat decoHelperThisOrThat3 = new DecoHelperThisOrThat(
            4,
            ChanceType.NOT_EQUALS_ZERO,
            bigSpruceTrees3,
            bigSpruceOakTrees3);
