...
public class SurfaceEBShield extends SurfaceEBBase {
    ...
    public SurfaceEBShield(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
        ...
        for (int k = 255; k > -1; k--) {
            ...
            if (b == Blocks.air) {
                ...
                if (shouldReplaceStone()) {
                    ...
                    metadata[(y * 16 + x) * 256 + k] = EBAPI.ebStonify(EBAPI.BASALT, hcStoneMeta(world, i, j, x, y, k));
                }
