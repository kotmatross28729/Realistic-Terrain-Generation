...
public class SurfaceVanillaExtremeHillsEdge extends SurfaceBase {
    ...
    public SurfaceVanillaExtremeHillsEdge(BiomeConfig config, Block top, Block filler, Block mixTop, Block mixFill,
        ...
        mixBlockTopMeta = this
            .getConfigBlockMeta(config, BiomeConfigVanillaExtremeHillsEdge.surfaceMixBlockMetaId, (byte) 0);
        ...
        mixBlockFillMeta = this
            .getConfigBlockMeta(config, BiomeConfigVanillaExtremeHillsEdge.surfaceMixFillerBlockMetaId, (byte) 0);
