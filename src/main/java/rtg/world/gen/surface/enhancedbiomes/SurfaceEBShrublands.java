...
public class SurfaceEBShrublands extends SurfaceEBBase {
    ...
    public SurfaceEBShrublands(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
