...
public class SurfaceCCEnderForest extends SurfaceBase {
    ...
    public SurfaceCCEnderForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
