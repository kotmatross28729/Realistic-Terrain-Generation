...
public class SurfaceIDTWillowForest extends SurfaceBase {
    ...
    public SurfaceIDTWillowForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
