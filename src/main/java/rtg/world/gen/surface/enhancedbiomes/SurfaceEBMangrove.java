...
public class SurfaceEBMangrove extends SurfaceEBBase {
    ...
    public SurfaceEBMangrove(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
