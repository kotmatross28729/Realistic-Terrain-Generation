...
public class RealisticBiomeGCBase extends RealisticBiomeBase {
    ...
    public RealisticBiomeGCBase(BiomeConfig config, BiomeGenBase b, BiomeGenBase riverbiome, TerrainBase t,
        SurfaceBase s) {
        ...
        if (Loader.isModLoaded("Growthcraft|Bamboo")) {
            ...
            for (int i = 0; i < 256; i++) {
                if (b[i] != null) {
                    ...
                    if ((biomeName == "BambooForest" || biomeName == "Bamboo Forest")
                        && biomeClass == "growthcraft.bamboo.common.world.BiomeGenBamboo") {
                        gcBambooForest = new RealisticBiomeGCBambooForest(
                            gcBiome,
                            BiomeConfigGC.biomeConfigGCBambooForest);
                    }
                }
            }
        }
