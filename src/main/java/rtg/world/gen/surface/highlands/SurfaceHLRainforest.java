...
public class SurfaceHLRainforest extends SurfaceBase {
    ...
    public SurfaceHLRainforest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
