...
public abstract class ATGBiomes {
     ...
     *
     * @param generate
     *                    Set to false to prevent this group generating in the default manner. Primarily for use with
     *                    the biome group assignment events.
     *
     * @param suitability
     *                    Offset to group suitability. Higher numbers make the group more likely to be picked. Small
     *                    changes can have a big effect. Default 0.0.
     */
    public static void addBiomeGroup(BiomeType type, String name, double temp, double moisture, double height,
        double minHeight, double maxHeight, long salt, boolean generate, double suitability) {
    ...
    public static void addBiomeGroup(BiomeType type, String name, double temp, double moisture, double height,
        ...
        addBiomeGroup(type, name, temp, moisture, height, minHeight, maxHeight, salt, generate, 0.0);
    }
