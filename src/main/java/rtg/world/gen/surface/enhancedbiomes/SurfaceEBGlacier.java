...
public class SurfaceEBGlacier extends SurfaceEBBase {
    ...
    public SurfaceEBGlacier(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
