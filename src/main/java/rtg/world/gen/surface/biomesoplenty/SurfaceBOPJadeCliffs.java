...
public class SurfaceBOPJadeCliffs extends SurfaceBase {
    ...
    public SurfaceBOPJadeCliffs(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
