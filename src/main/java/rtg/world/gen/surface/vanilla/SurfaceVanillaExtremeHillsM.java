...
public class SurfaceVanillaExtremeHillsM extends SurfaceBase {
    ...
    public SurfaceVanillaExtremeHillsM(BiomeConfig config, Block top, Block filler, Block mixTop, Block mixFill,
        ...
        mixBlockTopMeta = this
            .getConfigBlockMeta(config, BiomeConfigVanillaExtremeHillsM.surfaceMixBlockMetaId, (byte) 0);
        ...
        mixBlockFillMeta = this
            .getConfigBlockMeta(config, BiomeConfigVanillaExtremeHillsM.surfaceMixFillerBlockMetaId, (byte) 0);
