...
public class SurfaceVanillaRoofedForest extends SurfaceBase {
    ...
    public SurfaceVanillaRoofedForest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        ...
        mixBlock = this.getConfigBlock(config, BiomeConfigVanillaRoofedForest.surfaceMixBlockId, mix);
        mixBlockMeta = this.getConfigBlockMeta(config, BiomeConfigVanillaRoofedForest.surfaceMixBlockMetaId, mixByte);
        mixHeight = mixSize;
    }
