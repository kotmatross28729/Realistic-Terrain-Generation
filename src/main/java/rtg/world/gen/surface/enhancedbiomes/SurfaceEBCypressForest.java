...
public class SurfaceEBCypressForest extends SurfaceEBBase {
    ...
    public SurfaceEBCypressForest(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
