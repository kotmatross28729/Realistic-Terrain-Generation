...
public class SurfaceVanillaForestHills extends SurfaceBase {
    ...
    public SurfaceVanillaForestHills(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        ...
        mixBlock = this.getConfigBlock(config, BiomeConfigVanillaForestHills.surfaceMixBlockId, mix);
        mixBlockMeta = this.getConfigBlockMeta(config, BiomeConfigVanillaForestHills.surfaceMixBlockMetaId, mixByte);
        mixHeight = mixSize;
    }
