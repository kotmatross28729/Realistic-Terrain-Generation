...
public class SurfaceBOPSpruceWoods extends SurfaceBase {
    ...
    public SurfaceBOPSpruceWoods(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
