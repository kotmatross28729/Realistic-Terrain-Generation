package rtg.world.gen.surface.ridiculousworld;
...
public class SurfaceRWBotanicalGarden extends SurfaceBase {
    ...
    public SurfaceRWBotanicalGarden(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff, Block mix,
        float mixSize) {
        ...
        mixBlock = this.getConfigBlock(config, BiomeConfigRWBotanicalGarden.surfaceMixBlockId, mix);
        mixBlockMeta = this.getConfigBlockMeta(config, BiomeConfigRWBotanicalGarden.surfaceMixBlockMetaId, (byte) 0);
        mixHeight = mixSize;
    }
