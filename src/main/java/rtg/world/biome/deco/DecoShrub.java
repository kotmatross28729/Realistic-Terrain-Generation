...
public class DecoShrub extends DecoBase {
    ...
    public DecoShrub() {
        ...
        this.strengthFactor = 3f; // Not sure why it was done like this, but... the higher the value, the more there
                                  // will be.
    ...
    public void generate(RealisticBiomeBase biome, World world, Random rand, int chunkX, int chunkY,
        ...
        if (this.allowed) {
            ...
            if (this.useDefaultRandom && this.randomLogBlocks.length > 0
            ...
            WorldGenerator worldGenerator = new WorldGenShrubRTG(
                this.size,
                this.logBlock,
                this.logMeta,
                this.leavesBlock,
    ...
    private boolean generateWorldGenerator(WorldGenerator worldGenerator, WorldUtil worldUtil, World world, Random rand,
        int x, int y, int z, boolean hasPlacedVillageBlocks) {
