...
public class RealisticBiomeBCBase extends RealisticBiomeBase {
    ...
    public RealisticBiomeBCBase(BiomeConfig config, BiomeGenBase b, BiomeGenBase riverbiome, TerrainBase t,
        SurfaceBase s) {
            ...
            for (int i = 0; i < 256; i++) {
                if (b[i] != null) {
                    ...
                    if (biomeName == "Desert Oil Field"
                        ...
                        bcDesertOilField = new RealisticBiomeBCDesertOilField(
                            bcBiome,
                            BiomeConfigBC.biomeConfigBCDesertOilField);
                    } else if (biomeName == "Ocean Oil Field"
                        && biomeClass == "buildcraft.energy.worldgen.BiomeGenOilOcean") {
                            bcOceanOilField = new RealisticBiomeBCOceanOilField(
                                bcBiome,
                                BiomeConfigBC.biomeConfigBCOceanOilField);
                        }
                }
            }
        }
