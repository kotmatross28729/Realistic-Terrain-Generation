...
public class SurfaceEBXLMountainTaiga extends SurfaceBase {
    ...
    public SurfaceEBXLMountainTaiga(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
