...
public class SurfaceEBXLGreenHills extends SurfaceBase {
    ...
    public SurfaceEBXLGreenHills(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
