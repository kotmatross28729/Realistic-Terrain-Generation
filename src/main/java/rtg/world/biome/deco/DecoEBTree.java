                    ...
                    switch (this.treeType) {
                        ...
                        case FORESTED_VALLEY:
                            ...
                            if (intY <= this.maxY && intY >= this.minY && isValidTreeCondition(noise, rand, strength)) {
                                ...
                                WorldGenerator worldgenerator = rand.nextInt(2) == 0 ? TreeGen.birch()
                                    : rand.nextInt(10) != 0 ? new WorldGenTreesRTG(false)
                        ...
                        case SCRUB:
                            ...
                            if (intY <= this.maxY && intY >= this.minY && isValidTreeCondition(noise, rand, strength)) {
                                ...
                                if (rand.nextInt(4) != 0) {
                                    WorldGenerator spikedBush = new WorldGenSpikedBush(
                                        Blocks.log,
                                        0,
                                        Blocks.leaves,
                                        0,
                                    ...
                                    new WorldGenShrubRTG(
                                        rand.nextInt(4) + 1,
                                        Blocks.log,
                                        (byte) 0,
                                        Blocks.leaves,
                                        (byte) rand.nextInt(3)).generate(world, rand, intX, intY, intZ);
                                }
                            }
