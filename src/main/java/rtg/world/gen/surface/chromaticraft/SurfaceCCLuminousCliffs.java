...
public class SurfaceCCLuminousCliffs extends SurfaceBase {
    ...
    public SurfaceCCLuminousCliffs(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock,
        float minCliff) {
