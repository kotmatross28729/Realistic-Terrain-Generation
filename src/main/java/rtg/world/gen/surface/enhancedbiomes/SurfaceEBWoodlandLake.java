...
public class SurfaceEBWoodlandLake extends SurfaceEBBase {
    ...
    public SurfaceEBWoodlandLake(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
