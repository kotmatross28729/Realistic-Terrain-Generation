...
public class SurfaceBOPVolcano extends SurfaceBase {
    ...
    public SurfaceBOPVolcano(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop,
