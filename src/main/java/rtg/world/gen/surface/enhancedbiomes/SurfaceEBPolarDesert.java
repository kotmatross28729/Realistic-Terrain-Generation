...
public class SurfaceEBPolarDesert extends SurfaceEBBase {
    ...
    public SurfaceEBPolarDesert(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte,
            ...
            if (b == Blocks.air) {
                ...
                if (shouldReplaceStone()) {
                    ...
                    metadata[(y * 16 + x) * 256 + k] = EBAPI
                        .ebStonify(EBAPI.RHYOLITE, hcStoneMeta(world, i, j, x, y, k));
                }
                ...
                if (riverPaint) {
                    if (grass && depth < 4) {
                        ...
                        if (rand.nextInt(2) == 0) {
                            ...
                            metadata[(y * 16 + x) * 256 + k] = EBAPI
                                .ebStonify(EBAPI.RHYOLITE, hcCobbleMeta(world, i, j, x, y, k));
                        }
                    }
